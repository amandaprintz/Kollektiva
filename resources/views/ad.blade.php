                ...
                <div class="button-container">
                    <form>
                        <label for="first_upload">
                            <svg width="39" height="34" fill="none">
                                <path d="M0 4.857C0 3.57.514 2.334 1.428 1.423A4.884 4.884 0 0 1 4.875 0h29.25c1.293 0 2.533.512 3.447 1.423A4.848 4.848 0 0 1 39 4.857v24.286a4.848 4.848 0 0 1-1.428 3.434A4.884 4.884 0 0 1 34.125 34H4.875a4.884 4.884 0 0 1-3.447-1.423A4.848 4.848 0 0 1 0 29.143V4.857Zm2.438 21.857v2.429c0 .644.256 1.262.713 1.717a2.442 2.442 0 0 0 1.724.711h29.25c.647 0 1.267-.255 1.724-.71a2.424 2.424 0 0 0 .714-1.718v-8.5l-9.207-4.729a1.223 1.223 0 0 0-1.406.226l-9.043 9.01-6.484-4.303a1.222 1.222 0 0 0-1.536.15l-6.45 5.717ZM14.624 10.93c0-.967-.385-1.893-1.07-2.576a3.663 3.663 0 0 0-5.172 0 3.636 3.636 0 0 0 0 5.152 3.663 3.663 0 0 0 5.171 0 3.636 3.636 0 0 0 1.071-2.576Z" fill="#37455D" />
                            </svg>
                            Ladda upp fil
                        </label>
                    ...
                    <form method="view" action="{{ route('preview') }}">
                        ...
                        <div>
                            ...
                            <div class="checkboxes">
                                <label class="check-container">
                                    <span>Ja</span>
                                    <input type="radio" name="balcony" class="hidden" checked>
                                    <span class="checkmark"></span>
                                </label>
                                <label class="check-container">
                                    <span>Nej</span>
                                    <input type="radio" name="balcony" class="hidden">
                                    <span class="checkmark"></span>
                                </label>
                            </div>
