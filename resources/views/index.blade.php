            ...
            <div class="profile-links">
                <a href="#">
                    <svg width="30" height="30" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M20 10.666a5.333 5.333 0 1 1-10.667 0 5.333 5.333 0 0 1 10.667 0Zm-2.667 0a2.667 2.667 0 1 1-5.333 0 2.667 2.667 0 0 1 5.333 0Z" fill="colors.$blue" />
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M14.667 0C6.567 0 0 6.567 0 14.667s6.567 14.666 14.667 14.666 14.666-6.566 14.666-14.666C29.333 6.567 22.767 0 14.667 0Zm-12 14.667c0 2.786.95 5.352 2.544 7.389a11.982 11.982 0 0 1 9.542-4.723 11.98 11.98 0 0 1 9.456 4.611 12 12 0 1 0-21.542-7.277Zm12 12a11.951 11.951 0 0 1-7.563-2.683A9.323 9.323 0 0 1 14.754 20a9.32 9.32 0 0 1 7.585 3.893 11.952 11.952 0 0 1-7.672 2.774Z" fill="colors.$blue" />
                    </svg>
                    Min profil
                </a>
                <a href="#">
                    <svg width="35" height="32">
                        <path d="M24.334 31.333H3a2.667 2.667 0 0 1-2.667-2.666V12.55A2.667 2.667 0 0 1 3 10h21.334A2.667 2.667 0 0 1 27 12.667v16a2.667 2.667 0 0 1-2.666 2.666ZM3 15.157v13.51h21.334v-13.51l-10.667 7.11L3 15.157Zm1.067-2.49 9.6 6.4 9.6-6.4h-19.2Z" fill="colors.$blue" />
                        <rect x="15" width="20" height="20" rx="10" fill="#E21212" />
                        <path d="M19.98 14.08c.9 1.2 2.66 2.16 5.04 2.16 3.08 0 5.02-1.62 5.02-3.88 0-2.06-1.8-3.12-3.1-3.24 1.38-.24 2.9-1.28 2.9-3.06 0-2.24-1.94-3.6-4.82-3.6-2.22 0-3.84.9-4.86 2.1l1.2 1.46c.96-.96 2.08-1.48 3.44-1.48 1.5 0 2.7.64 2.7 1.88 0 1.22-1.18 1.76-2.74 1.76-.52 0-1.3 0-1.54-.02v2.1c.2-.02.98-.02 1.54-.02 1.9 0 2.96.56 2.96 1.88 0 1.24-1.02 2.04-2.78 2.04-1.42 0-2.84-.62-3.7-1.62l-1.26 1.54Z" fill="#F9FAFB" />
                    </svg>
                    Meddelanden</a>
            </div>
